...
<!-- show anime list -->
            <section>
                <div class="d-flex flex-row row">
                    ...
                    $has_wishlist_anime = false; // Track if any anime is in the wishlist
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if ($is_in_wishlist) {
                                $has_wishlist_anime = true; // Mark that we found a wishlist anime
                                include("template.php");
                            }
                        }

                        // If no anime was in the wishlist, show "No results found"
                        if (!$has_wishlist_anime) {
                            ?>
                        ...
                        // If no anime entries exist in the database at all
                        ?>
                        <h1>No results found.</h1>
                        <div class="d-flex justify-content-center" style="height: 100%;">
                            <img loading="lazy" src="https://media.tenor.com/i9UkjLlNlt4AAAAC/anime-sorry.gif" alt="Description of the image" class="img-fluid">
