<?php
    ...
    // function getPassValidation($password): array {
    //     $errors = [];
    ...
    //         $errors[] = "Mật khẩu phải có ít nhất một chữ viết hoa.";
    //     }
    ...
    //         $errors[] = "Mật khẩu phải có ít nhất một ký tự đặc biệt (ví dụ: !@#$%^&*).";
    //     }
    ...
    function getPassValidation($password) {
        $errors = [];
