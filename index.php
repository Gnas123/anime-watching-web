<?php
    ...
    $starter = 0;
    $skip = 2;          // number of item per page 
    ...
    ";
    // $sql = "
    //     SELECT a.anime_id, a.anime_name, a.price, c.cate_name
    //     FROM anime a 
    //     LEFT JOIN ani_cate ac ON a.anime_id = ac.anime_id 
    //     LEFT JOIN category c ON ac.cate_id = c.cate_id 
    //     WHERE a.anime_name LIKE '%$search_zone%'
    //     OR c.cate_name LIKE '%$search_zone%'
    //     OR a.price LIKE '%$search_zone%';
    // ";
