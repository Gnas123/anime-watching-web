...
<header class="sticky-top">
    ...
    <!-- left items of navbar -->
        ...
        <!-- anime button -->
                    ...
                    <li class="nav-item">
                        <a class="navbutton text-white nav-link w-100" href="anime">Anime</a>
                        <!-- <a class="navbutton text-white nav-link w-100" href="/website/anime">Anime</a> -->
                    </li>
                    <!-- <li class="nav-item">
        ...
        <!-- new button -->
                    <li class="nav-item">
                        <a class="navbutton text-white nav-link w-100" href="map">Map</a>
                    </li>
        <!-- categories button -->
        ...
        <!-- muc yeu thich va login -->
                <div class="d-flex align-items-center justify-content-center mt-1">
                    <a href="anime_wishlist" class="text-white move-up-icon">
                    ...
                    <?php
                        ...
                        if(isset($_SESSION['islogin']) && $_SESSION['islogin']==true){
                            ...
                            // chua login
                            echo '
                                <a id="login-form" href="login" method="get" style="color: white; border: none; background-color: transparent;">
